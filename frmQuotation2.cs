...
namespace QuintonPOS
{
    ...
    {
        public frmQuotation2(List<string> salesDetails)
        {
            InitializeComponent();
        ...
        private void frmQuotation_Load(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem item in frmPlaceOrder.transListView.Items)
            {
            ...
            richTextBox1.AppendText("\n");
            richTextBox1.AppendText("\n");
            richTextBox1.AppendText("CUSTOMER ALIAS: " + "\n" + frmPlaceOrder.customerName + "\n" + "\n" + "\n");
            richTextBox1.AppendText("PREFERRED PAYMENT METHOD: " + "\n" + frmPlaceOrder.paymentMethod + "\n" + "\n" + "\n");
            richTextBox1.AppendText("TAX: " + "\t" + frmPlaceOrder.qTAX + "\n" + "\n" + "\n");
            richTextBox1.AppendText("DISCOUNT: " + "\t" + frmPlaceOrder.qDiscount  + "\n" + "\n" + "\n");
            richTextBox1.AppendText("TOTAL COST: " + "$" + frmPlaceOrder.ItTotalCost + "\n" + "\n");
            richTextBox1.AppendText("-------------------------------------------------------------");
            richTextBox1.AppendText("\n");
            richTextBox1.AppendText("TELLER: " + frmPlaceOrder.tellerName + "\n" + "\n");
